...
namespace satis_form
{
    public partial class frmÜrünEkle : Form
    {
        ...
        private int BarkodOlustur()
        {
            DateTime barkod = new DateTime();
            return Convert.ToInt32(barkod.Millisecond);
        }

        private void frmÜrünEkle_Load(object sender, EventArgs e)
        {
            kategorigetir();
            txtBarkodNo.Text = BarkodOlustur().ToString();
            frmAnasayfa frmAnasayfa = new frmAnasayfa();
            frmAnasayfa.btnUrunIslemleri.BackColor = Color.DarkBlue;
        }
